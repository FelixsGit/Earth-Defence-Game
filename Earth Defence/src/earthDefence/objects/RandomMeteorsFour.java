...
public class RandomMeteorsFour extends GameObject{
	...
	public RandomMeteorsFour(float x, float y, Handler handler, ObjectId id) {
		super(x, y, id);
	...
	public void tick(LinkedList<GameObject> object) {
		...
		if(BossEnemyShip.waitForMoonExploding >= 19000){
			velY = 3;
			velX = -1;
		}
	...
	public void collision(LinkedList<GameObject> object){
		...
		for(int i = 0; i < handler.object.size(); i++){
			GameObject tempObject = handler.object.get(i);
			if(tempObject.getId() == ObjectId.RandomMeteorsFour){
